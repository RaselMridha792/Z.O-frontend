...
export default function UpdatePasswordPage() {
    ...
    if (typeof window !== "undefined") {
      ...
      if (hash) {
        ...
        if (token) {
          ...
          setMessage(
            "আপনার অ্যাকাউন্ট যাচাই করা হয়েছে। নতুন পাসওয়ার্ড সেট করুন।"
          );
        } else {
          setTokenReceived(false);
          setError(
            "ত্রুটি: পাসওয়ার্ড রিসেট টোকেন পাওয়া যায়নি বা মেয়াদ উত্তীর্ণ হয়েছে।"
          );
        }
      } else {
        setTokenReceived(false);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(
        "পাসওয়ার্ড সফলভাবে আপডেট করা হয়েছে! এখন আপনি লগইন করতে পারেন।"
      );
      setPassword("");
      setConfirmPassword("");
      setTimeout(() => {
      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-xl shadow-2xl">
        ...
        {tokenReceived ? (
          ...
          <div className="text-center text-gray-600">
            পাসওয়ার্ড রিসেট করার জন্য আপনার ইমেল ইনবক্সে পাঠানো লিঙ্কটি ব্যবহার
            করুন।
          </div>
        )}
      </div>
